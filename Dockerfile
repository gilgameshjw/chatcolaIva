...
RUN mkdir ./logs ./src ./resources ./libDocker
RUN echo > ./logs/chatcola.log

COPY /src/ ./src/
COPY /resources/ ./resources/

ADD packageInstalls.jl packageInstalls.jl
RUN julia packageInstalls.jl

ADD scriptRunChatcolaIVA.jl scriptRunChatcolaIVA.jl 
CMD julia scriptRunChatcolaIVA.jl
